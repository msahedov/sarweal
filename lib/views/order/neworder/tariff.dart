      ...
      return ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Töleg usulyny saýlaň",
          ...
          ListTile(
            ...
            shape: RoundedRectangleBorder(
                ...
                side: controller.paymentMethod?.value == PaymentMethod.full
          ...
          Padding(
            ...
            child: ListTile(
              ...
              shape: RoundedRectangleBorder(
                  borderRadius: circular10,
                  side: controller.paymentMethod?.value == PaymentMethod.partial
                      ? const BorderSide(color: primaryColor_2)
                      : BorderSide(color: Colors.grey.shade300)),
              selectedTileColor: primaryColor_2.withOpacity(0.1),
              selectedColor: primaryColor_2.withOpacity(0.4),
          ...
          ListTile(
            ...
            shape: RoundedRectangleBorder(
                borderRadius: circular10,
                side: controller.paymentMethod?.value == PaymentMethod.zero
                    ? const BorderSide(color: primaryColor_2)
                    : BorderSide(color: Colors.grey.shade300)),
            selectedTileColor: primaryColor_2.withOpacity(0.1),
            selectedColor: primaryColor_2.withOpacity(0.4),
