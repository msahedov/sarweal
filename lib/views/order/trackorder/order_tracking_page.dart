  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        // title: Text('Kargo Takibi - Sarweal', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.grey.shade600)),
      ),
      body: ListView(
        ...
        children: [
          Text('Kargo Takibi',
              style: Theme.of(context)
                  .textTheme
                  .headlineSmall
                  ?.copyWith(fontSize: 20, color: Colors.black, fontWeight: FontWeight.w500)),
          Padding(
          ...
          ListTile(
            ...
            title: Text('Paketiňizde',
                style: Theme.of(context)
                    .textTheme
                    .caption
                    ?.copyWith(fontSize: 10, color: Colors.grey.shade500)),
            subtitle: Text('1 haryt bar',
                style: Theme.of(context)
                    .textTheme
                    .caption
                    ?.copyWith(fontSize: 10, color: Colors.grey.shade500)),
          ...
          // Text("Kargo hereketlerini detayli goster", style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: primaryColor_2)),
          SizedBox(height: 40),
          Text("ELTIP BERME ADRESI",
